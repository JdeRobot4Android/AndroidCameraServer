...
// <auto-generated>
//
// Generated from file `remoteConfigPrxHelper.java'
//
...
public final class remoteConfigPrxHelper extends Ice.ObjectPrxHelperBase implements remoteConfigPrx
{
    ...
    private int
    initConfiguration(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                return __del.initConfiguration(__ctx);
            }
    ...
    private String
    read(int id, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    private int
    setConfiguration(int id, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _remoteConfigDel __del = (_remoteConfigDel)__delBase;
                return __del.setConfiguration(id, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex);
    ...
    private int
    write(String data, int id, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                ...
                __delBase = __getDelegate(false);
                _remoteConfigDel __del = (_remoteConfigDel)__delBase;
                return __del.write(data, id, __ctx);
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
                __handleExceptionWrapper(__delBase, __ex);
    ...
    public static void
    __write(IceInternal.BasicStream __os, remoteConfigPrx v)
    {
        __os.writeProxy(v);
    }
